<div>
  <svg {{ $attributes }}>
    <g data-name="Group 146" transform="translate(-64.456)">
      <circle data-name="Ellipse 161" cx="47.358" cy="47.358" r="47.358" transform="translate(96.534)"
        fill="#3f3d56"></circle>
      <circle data-name="Ellipse 162" cx="39.096" cy="39.096" r="39.096" transform="translate(104.797 8.262)"
        opacity="0.05"></circle>
      <circle data-name="Ellipse 163" cx="32.042" cy="32.042" r="32.042" transform="translate(111.85 15.316)"
        opacity="0.05"></circle>
      <circle data-name="Ellipse 164" cx="22.974" cy="22.974" r="22.974" transform="translate(120.918 24.384)"
        opacity="0.05"></circle>
      ...
      <path data-name="Path 634"
        ...
        fill="#2f2e41"></path>
      <circle data-name="Ellipse 165" cx="5.797" cy="5.797" r="5.797" transform="translate(77.365 28.042)"
        fill="#ffb8b8"></circle>
      <path data-name="Path 635"
        d="M79.436 35.743s-4.141 7.619-4.472 7.619 7.453 2.484 7.453 2.484 2.153-7.287 2.484-7.95z" fill="#ffb8b8">
      </path>
      <path data-name="Path 636"
        ...
        fill="#d0cde1"></path>
      <path data-name="Path 637" d="M90.407 76.832s2.62 8 .414 7.722-3.172-6.895-3.172-6.895z" fill="#ffb8b8"></path>
      <path data-name="Path 638"
        ...
        fill="#d0cde1"></path>
      <path data-name="Path 639" d="M80.271 65.182l6.343 11.308-5.343-11.918z" opacity="0.1"></path>
