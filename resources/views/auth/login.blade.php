<x-guest-layout>
  ...
  <div class="h-screen grid place-content-center bg-gradient-to-tl font-rubik from-green-500 via-green-600 to-green-800">
    ...
    <div class="bg-white w-[30rem] p-5 rounded-md shadow">
      ...
      <form method="POST" action="{{ route('login') }}" class="mt-5">
        ...
        <div class="mt-3">
          <x-jet-button class="w-full flex justify-center items-center py-3 bg-cgreen hover:bg-cgreen/75">
            {{ __('Log in') }}
          </x-jet-button>

          <div class="flex items-center mt-3 text-gray-600">
            <h1>If you don't have an account,</h1>
            <a href="{{ route('register') }}" class="text-cgreen ml-2 hover:underline">Register here</a>
          </div>
        </div>
        {{-- <div class="flex items-center justify-end mt-4">
                    @if (Route::has('password.request'))
