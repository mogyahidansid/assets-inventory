<div wire:poll>
  <div x-data="{ modal : @entangle('notifModal') }">
    ...
    <div class="bg-white w-[25rem] absolute top-14 right-5 max-h-[20rem] rounded-md border shadow" x-show="modal"
      x-cloak @click.away="modal = false">
